 ...
 *   deno task tavily "your search query" --answer    # Include AI-generated answer
 *   deno task tavily "your search query" --depth advanced  # Deeper search
 *   deno task tavily "your search query" --results 10  # More results
 * 
...
Usage:
  deno task tavily "search query" [options]
...
Examples:
  deno task tavily "Hono framework Deno setup"
  deno task tavily "latest AI news" --topic news --time week
  deno task tavily "React best practices" --answer --depth advanced
`);
}
